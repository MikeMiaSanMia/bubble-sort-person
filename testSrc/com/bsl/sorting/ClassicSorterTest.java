...
public class ClassicSorterTest {
	...
	@Test
	/**
	 * This method should test if PersonClassicSorter works.
	 * 
	 * Fix any errors the test might have found.
	 */
	public void shouldSortCollection() {
	    // GIVEN
        final PersonClassicSorter personClassicSorter = new PersonClassicSorter();
        final int firstIndex = 0;
        final int lastIndex = theTeam.size() - 1;

        // WHEN
        theTeam = personClassicSorter.sort(theTeam);
